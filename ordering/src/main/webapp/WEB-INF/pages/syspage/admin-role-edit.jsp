...
<article class="cl pd-20">
    <form action="${pageContext.request.contextPath}/role/updateRole" method="post" class="form form-horizontal" id="form-admin-role-add" target="_parent">
        <div class="row cl">
            <input type="hidden" name="id" value="${role.id}">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${role.name}" placeholder="" id="roleName" name="name" datatype="*4-16" >
            </div>
        </div>
        <div class="row cl">
