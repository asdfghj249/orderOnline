                            ...
                            <c:forEach items="${ois}" var="orderItem">
                                <tr>
                                    <td class="pro-thumbnail">
                                        <a href="${pageContext.request.contextPath}/fore/foreDetailUI?id=${orderItem.pid}"><img src="${pageContext.request.contextPath}/${orderItem.product.imageurl}" class="img-fluid" alt="Product"></a>
                                    </td>
                                    <td class="pro-title"><a href="${pageContext.request.contextPath}/fore/foreDetailUI?id=${orderItem.pid}">${orderItem.product.name}</a></td>
                                    ...
                                    <c:if test="${cst.status==0}">
                                        <td class="pro-subtotal"><span id="zongji1">$${orderItem.number*orderItem.product.price}</span></td>
                                    </c:if>
                                    <c:if test="${cst.status==1}">
                                        <td class="pro-subtotal"><span id="zongji2">$${orderItem.number*orderItem.product.price*0.8}</span></td>
                                    </c:if>
                                </tr>
                            </c:forEach>
                            </tbody>
                                            ...
                                            <div id="billing-form" class="mb-40">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12 mb-20">
                                                        <label>姓名</label>
                                                        <input type="text" name="name" id="name" value="${cst.name}">
                                                    </div>
                                                    <div class="col-md-6 col-12 mb-20">
                                                        <label>手机号</label>
                                                        <input type="text" name="phone" id="phone" value="${cst.phone}" >
                                                    </div>

                                                    <div class="col-md-12 col-12 mb-20">
                                                        <label>地址</label>
                                                        <input type="text" name="address" id="address"  value="${cst.address}">
                                                    </div>
...
<script type="text/javascript">
    ...
    function createOrder() {
        ...
        var cstAddress = "姓名："+name+",配送地址："+address+",手机号："+phone;
