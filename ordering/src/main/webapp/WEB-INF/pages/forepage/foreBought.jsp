...
<style>
    ...
    #myod{width:450px;height:140px;margin-left:35% ;font-size: 25px}
</style>
                        ...
                        <div class="tab-content" id="myaccountContent">
                            <div class="tab-pane fade show active"  role="tabpanel">
                                <div class="myaccount-content">
                                    <h3>Orders</h3>
                                    <c:if test="${os.size() == 0}">
                                        <div id="myod">您还没有订单<a href="${pageContext.request.contextPath}/fore/forecart" style="color: red">，请查看购物车！</a></div>
                                    </c:if>
                                                ...
                                                <td width="55%">
                                                    <c:forEach items="${order.orderItems}" var="oi">
                                                        <ul class="order_goods_list">
                                                            ...
                                                            <li class="col02">
                                                                <a href="${pageContext.request.contextPath}/fore/foreDetailUI?id=${oi.product.id}">${oi.product.name}</a>
                                                            </li>

                                                            <li class="col03">数量：${oi.number}</li>
                                                            <c:if test="${cst.status == 1}">
                                                                <li class="col04">总价：$${oi.product.price*oi.number*0.8}</li>
                                                            </c:if>
                                                            <c:if test="${cst.status != 1}">
                                                                <li class="col04">总价：$${oi.product.price*oi.number}</li>
                                                            </c:if>
