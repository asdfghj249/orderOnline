        ...
        <div class="row">
                    ...
                    <div class="tab-content product-large-image-list fl-product-large-image-list fl3-product-large-image-list" id="myTabContent">
                        <div class="tab-pane fade show active" id="single-slide-1" role="tabpanel" aria-labelledby="single-slide-tab-1">
                            ...
                            <div class="single-product-img img-full">
                                ...
                                <a href="${pageContext.request.contextPath}/${p.imageurl}" class="big-image-popup"><i class="fa fa-search-plus"></i></a>
                            </div>
                        ...
                        <div class="nav small-image-slider fl3-small-image-slider" role="tablist">
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-1" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/images/single-product-slider/01.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-2" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/images/single-product-slider/02.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-3" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/images/single-product-slider/03.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-4" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/images/single-product-slider/04.jpg" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-5" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/images/single-product-slider/05.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                ...
                <div class="product-feature-details">
                    <h2 class="product-title mb-15">${p.name}</h2>
                    ...
                    <p class="d-inline-block ml-10 review-link">
                        <a href="#">
                            <c:if test="${reviews.size()==null}">(0 customer review)</c:if>
                            <c:if test="${reviews.size()!=null}">(${reviews.size()} customer review)</c:if>
                        </a>
                    </p>
                    ...
                    <div class="cart-buttons mb-20">
                        ...
                        <div class="pro-qty mb-20">
                            ...
                            <a class="inc qty-btn" href="#" id="inc" >+</a>
                            <a class="dec qty-btn" href="#" id="dec" >-</a>
                        </div>
                    ...
                    <p class="wishlist-link mb-20 pb-15">
                        <a href="#" data-target="#quick-view-modal-container" id="nowPayment" > <i class="icon ion-md-options"></i> 立即购买</a>
                    </p>
        ...
        $("#nowPayment").click(function(){
            $.get(
                ...
                function(result) {
                    if (result=="true"){
                        number = $("#num").val();
                        location.href= "forebuyone?pid=${p.id}&number="+number;
                    }else {
                        $('#myModal').modal('show')
                    }
                }
